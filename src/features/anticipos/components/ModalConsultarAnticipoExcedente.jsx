...
import {
    Box, Typography, Chip, Button, Dialog, IconButton
} from '@mui/material'
        ...
        <Dialog open onClose={onClose} maxWidth="md" fullWidth
            ...
            <Box sx={{ p: 3 }}>
                <Box sx={{ display: 'flex', gap: 2 }}>
                    <FichaCard icon={PersonOutlinedIcon} title="Conductor y Ruta" subtitle="Recursos asignados al anticipo">
                    ...
                    <FichaCard icon={AccountBalanceWalletOutlinedIcon} title="Valores y Estado" subtitle="Montos, fechas y estado del anticipo">
                        <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', py: 0.9 }}>
