...
const ModalConsultarVehiculo = ({ vehiculo, onClose }) => {
    ...
    useEffect(() => {
        ...
        salidaService.getSalidas({ idVehiculo: vehiculo.idVehiculo, limit: 100 })
            ...
            {tabIndex === 0 && (
                <Box sx={{ p: 3 }}>
                    <Box sx={{ display: 'flex', gap: 2 }}>
                        <FichaCard icon={DirectionsCarOutlinedIcon} title="Datos del Vehículo" subtitle="Características y clasificación">
