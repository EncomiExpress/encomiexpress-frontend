...
// disabledStyle: Actualizar deshabilita este botón cuando no hay cambios y necesita
// un estilo Mui-disabled propio; Registrar nunca lo deshabilita por esa razón.
export const primaryButtonSx = (theme, { minWidth = 160, disabledStyle = false } = {}) => ({
    textTransform: 'none', borderRadius: 2, fontWeight: 600, minWidth,
    backgroundColor: theme.palette.primary.main,
    boxShadow: `0 4px 14px ${theme.palette.primary.activeBg}`,
    '&:hover': { backgroundColor: theme.palette.primary.dark, boxShadow: `0 6px 20px ${theme.palette.primary.activeBg}` },
    ...(disabledStyle ? { '&.Mui-disabled': { backgroundColor: theme.palette.divider, color: theme.palette.text.disabled } } : {}),
})
