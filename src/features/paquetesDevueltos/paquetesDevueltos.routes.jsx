...
const paquetesDevueltosRoutes = [
  <Route key="paquetes-no-entregados-listar" path="/paquetes-no-entregados/listar" element={<PrivateRoute permisosRequeridos={[PERMISOS.LISTAR_VENTA]}><ListarPaqueteDevuelto /></PrivateRoute>} />,
]
