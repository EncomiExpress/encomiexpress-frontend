...
/** Paso 1 del wizard de edición: cliente remitente (ya asignado) y datos del destinatario. */
export default function PasoParticipantes({
    theme, clientes, clienteSeleccionado, clienteInput, setClienteInput,
    form, setForm, errores, setErrores, handleChange, setSinCambios, ventaOriginal,
}) {
    return (
