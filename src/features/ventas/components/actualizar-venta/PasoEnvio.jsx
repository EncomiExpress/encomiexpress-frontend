...
/**
 * Paso 3 del wizard de edición: elegir la ruta, la fecha de entrega y asignar cada
 * paquete a un vehículo del convoy. `getPesoOriginalPorPar` excluye el peso que esta
 * misma venta ya tenía en cada vehículo antes de editar, para no restarlo dos veces
 * al calcular la capacidad disponible.
 */
