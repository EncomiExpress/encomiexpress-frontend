...
// compact: ListarSalidaProgramada.jsx usa una variante más chica (height:18, ancho
// ajustado al contenido) para que el chip quepa debajo del vehículo/conductor en la
// celda de la tabla; ModalConsultarSalidaProgramada.jsx usa el tamaño normal (height:20).
