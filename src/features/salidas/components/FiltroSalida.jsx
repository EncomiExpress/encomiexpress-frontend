...
// No es un estado real de la salida — es un pseudo-filtro (el backend lo traduce a
// "Completada + sin regreso enlazado + convoy fuera de base").
const ESTADO_REGRESO_PENDIENTE = 'Regreso pendiente'
// Tampoco es un estado real — toda salida que ES un viaje de regreso (idSalidaIda no
