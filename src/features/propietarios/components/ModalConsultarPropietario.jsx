            ...
            {tabIndex === 0 && (
                <Box sx={{ p: 3 }}>
                    <Box sx={{ display: 'flex', gap: 2 }}>
                        <FichaCard icon={AssignmentIndOutlinedIcon} title="Detalles del Propietario" subtitle="Identificación y datos personales">
                        ...
                        <FichaCard icon={PhoneOutlinedIcon} title="Contacto y Flota" subtitle="Datos de contacto y flota">
