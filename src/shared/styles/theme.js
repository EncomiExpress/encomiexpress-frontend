...
const darkPalette = {
  ...
  roles: {
    Administrador: { bg: '#B71C1C', color: '#EF5350' },
    Gerente: { bg: '#C62828', color: '#EF5350' },
    Vendedor: { bg: '#EF6C00', color: '#FFB74D' },
    Conductor: { bg: '#880E4F', color: '#FF8A80' },
    Auxiliar: { bg: '#EF6C00', color: '#FFB74D' },
    default: { bg: '#424242', color: '#AAAAAA' },
  },
  gradient: {
