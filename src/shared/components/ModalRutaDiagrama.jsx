...
// Modal liviano para revisar el origen/destino de una ruta antes de confirmarla.
const ModalRutaDiagrama = ({ open, onClose, origen, destino, subtitulo }) => {
    ...
    return (
        <Dialog open={open} onClose={onClose} maxWidth="sm" fullWidth
            ...
            <Box sx={{ px: 1, pb: 3, pt: 2 }}>
                <RutaDiagrama origen={origen} destino={destino} />
            </Box>
        </Dialog>
    )
}
